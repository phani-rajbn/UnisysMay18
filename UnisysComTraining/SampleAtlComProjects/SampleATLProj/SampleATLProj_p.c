...
extern const MIDL_SERVER_INFO IFirstComponent_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFirstComponent_ProxyInfo;
...
/* Object interface: IFirstComponent, ver. 0.0,
   GUID={0x5E70BFC9,0x2A95,0x4633,{0x88,0xFC,0x79,0x15,0x77,0x1B,0x3D,0x57}} */

#pragma code_seg(".orpc")
static const unsigned short IFirstComponent_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IFirstComponent_ProxyInfo =
    {
    &Object_StubDesc,
    SampleATLProj__MIDL_ProcFormatString.Format,
    &IFirstComponent_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFirstComponent_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SampleATLProj__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IFirstComponentProxyVtbl = 
{
    &IFirstComponent_ProxyInfo,
    &IID_IFirstComponent,
    ...
    (void *) (INT_PTR) -1 /* IFirstComponent::AddNumbers */
};


static const PRPC_STUB_FUNCTION IFirstComponent_table[] =
{
...
CInterfaceStubVtbl _IFirstComponentStubVtbl =
{
    &IID_IFirstComponent,
    &IFirstComponent_ServerInfo,
    8,
    &IFirstComponent_table[-3],
...
{
    ( CInterfaceProxyVtbl *) &_IFirstComponentProxyVtbl,
    0
};
...
const ExtendedProxyFileInfo SampleATLProj_ProxyFileInfo = 
{
