#pragma once
#include "OuterComponent.h"//Component implementation...
...
public:
	...
	STDMETHOD(CreateInstance)(IUnknown * pUnkOuter, REFIID riid, void ** ppvObject) {
		...
		OuterMathComponent* pCOM = new OuterMathComponent();
		HRESULT hr = pCOM->Init();//Inner Component so that its pointers are set...
		if (FAILED(hr))
			return hr;
